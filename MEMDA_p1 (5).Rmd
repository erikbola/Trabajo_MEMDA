...
```{r}
datos_prepro<-datos_final[,c("liveness_boxcox", "acousticness_boxcox", "danceability", "audio_valence","outlier")]
...
#CART: METODO CLASS ADAPTADO A REGR
```{r}
