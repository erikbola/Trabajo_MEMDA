...
---
Nota: En la linea 881 se encuentra el load() con los objetos principales resultados del preprocesamiento. 
...
## 4.2 Ajuste del modelo con cada combinación
...
El **RMSE** obtenido a partir del modelo ajustado en base al Random Forest es de 20.5327.

# 5. Submission Random Forest (RF)
...
submission_RF <- data.frame(ID = TEST_num$ID, "song_popularity" = RF)

# Exportar a CSV (sin comillas ni índice)
write.table(submission_RF, 
